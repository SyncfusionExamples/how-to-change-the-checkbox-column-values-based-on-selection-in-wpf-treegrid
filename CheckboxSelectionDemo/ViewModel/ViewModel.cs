...
namespace SelectionDemo
{
    ...
    public class ViewModel
    {
        ...
        public ViewModel()
        {
            ...
            SelectedItem = this.EmployeeInfo[29];
        }
        ...
        public List<EmployeeInfo> GetEmployees()
        {
            ...
            model.Add(new EmployeeInfo() { Title = "General Manager", ReportsTo = -1, ID = 2, FirstName = "Sean", LastName = "Jacobson", EmpID = 1001, Salary = 200000,IsSelected=false });
            model.Add(new EmployeeInfo() { Title = "Accounts Manager", ReportsTo = -1, ID = 3, FirstName = "Phyllis", LastName = "Allen", EmpID = 1002, Salary = 175000,IsSelected=true});
